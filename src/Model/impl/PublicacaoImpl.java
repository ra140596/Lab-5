 ...
 *   <li>{@link Model.impl.PublicacaoImpl#getCodigo <em>Codigo</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PublicacaoImpl extends MinimalEObjectImpl.Container implements Publicacao {
	...
	public void setCodigo(int newCodigo) {
		...
		codigo = newCodigo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PUBLICACAO__CODIGO, oldCodigo, codigo));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.PUBLICACAO__TITULO:
				return getTitulo();
			case ModelPackage.PUBLICACAO__CODIGO:
				return getCodigo();
		}
